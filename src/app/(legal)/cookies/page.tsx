...
export default function CookiesPage() {
  return (
    <>
      ...
      <Table
        rows={[
          ["hypefy_feed_seen, hypefy_seen_shows, hypefy:diary:seen", "Which posts, Shows and Diaries you have already seen, so they are not shown as new again.", "Until cleared"],
