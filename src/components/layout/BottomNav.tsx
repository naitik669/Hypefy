  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 mx-auto flex h-[72px] w-full max-w-[480px] items-center justify-around border-t border-border/60 bg-background/85 px-2 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl">
      ...
      <Link
        href="/create"
        aria-label="Create"
        className="flex h-11 w-[68px] items-center justify-center rounded-[20px] bg-accent text-accent-ink shadow-[0_8px_24px_-6px_rgba(200,255,0,0.6)] transition-transform active:scale-95"
      >
